...
func progressUpdate(steps: Int, goal: Int) {
    if steps < goal / 10 {
        ...
        print("You've met your daily step goal!")
    } else {
        print("You've exceeded your step goal by \(steps - goal) \(steps - goal > 1 ? "steps" : "step")! Awesome!")
    }
}
progressUpdate(steps: 10, goal: 1_000)          // Off to a good start
progressUpdate(steps: 150, goal: 1_000)         // You're almost halfway there
progressUpdate(steps: 499, goal: 1_000)         // You're almost halfway there
progressUpdate(steps: 501, goal: 1_000)         // You're over halfway there
progressUpdate(steps: 999, goal: 1_000)         // You're over halfway there
progressUpdate(steps: 1_000, goal: 1_000)       // You've met your daily step goal
progressUpdate(steps: 1_003, goal: 1_000)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    print(currentPace >= goalPace ? "Keep it up!" : "You've got to push it just a bit harder!")
}
pacing(currentDistance: 100, totalDistance: 200, currentTime: 30, goalTime: 50)
