 ...
 */
let somePlace = GPS(latitude: 51.5004, longitude: 0.125226)
print(somePlace.toString())
...
let myFavoriteBook = Book(name: "I don't have a favorite book", author: "IDK Lol", pages: 123, price: 69.420)
print(myFavoriteBook.toString())
/*:
...
struct Height {
    // STATIC PROPERTIES
    static var inchesToCentimeters = 2.54       // proportionality constant
    
    // INSTANCE PROPERTIES
    var heightInInches: Double = 1
    var heightInCentimeters: Double = 1
    
    // CUSTOM INITIALIZERS
    // Inches
    init(inches: Double) {
        heightInInches = inches
        heightInCentimeters = heightInInches * Height.inchesToCentimeters
    }
    
    // Centimeters
    init(centimeters: Double) {
        heightInCentimeters = centimeters
        heightInInches = heightInCentimeters / Height.inchesToCentimeters
    }
}
 ...
 */
var myHeight = Height(centimeters: 165)
