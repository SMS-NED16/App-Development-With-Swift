...
struct Height {
    var heightInInches: Double = 1 {
        didSet {
            print("The heightInInches property was set.")
    ...
    var heightInCentimeters: Double = 1 {
        didSet {
            print("The heightInCentimeters property was set.")
...
myHeight.heightInCentimeters = 164

var myOtherHeight = Height(heightInInches: 65)
