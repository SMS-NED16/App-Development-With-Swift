...
class ShieldedShip: Fighter {
    ...
    override func wasHit() {
        if shieldStrength > 0 {
            ...
            super.wasHit()              // this is basically the same as the superclass's instructions
        }
    }
}
...
defender.moveRight(); print(defender.position)
defender.fire(); print(defender.remainingFirePower)
/*:
