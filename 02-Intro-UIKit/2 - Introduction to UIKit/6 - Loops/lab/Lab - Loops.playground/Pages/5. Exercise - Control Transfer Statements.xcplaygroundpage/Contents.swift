 ...
 */
var statesAndCapitals: [String: String] = ["Sindh": "Karachi", "Punjab": "Lahore", "Balochistan": "Quetta", "KPK": "Peshawar"]
for (state, city) in statesAndCapitals {
    print("The capital city of \(state) is \(city).")
    
    if city.lowercased() == "karachi" {
