 ...
 */
heartRate = 74
print(heartRate!)       // force unwrapping the optional to display integer value instead of Optional object
/*:
...
// print(hrAverage)    // will not print anything, heartRate is an optional, needs to be unwrapped first
/*:
 ...
 */
let HRSum = oldHR1 + oldHR2 + oldHR3 + oldHR4
if let currentHR = heartRate {
    print("Average heart rate is: \((currentHR + HRSum) / 5).")
} else {
    print("Previous heart rate is: \(HRSum / 4)")
}
