 ...
 */
print("Expected result of integer division of 10 by 3: " + String(3))
let integerDivisionResult = 10 / 3
print("Actual integer division result: " + String(integerDivisionResult))
...
print(divisionResult)      // 3.333
// Dividing two integers results in an integer. Dividing two floats/Doubles results in another float/decimal number
/*:
...
print("The radius of the circle is: " + String(radius))
print("The diameter of the circle is: " + String(diameter))
print("The circumfrence of the circle is: " + String(circumfrence))
