...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // Allow app delegate to access app delegate method count properties in ViewController
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        // As this method will be callled after each of the other lifecycle methods
        // and also before the user can interact with the app again, this is
        // where we should update the viewController
